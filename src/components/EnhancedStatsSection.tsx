          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Our evidence-based approach delivers real, measurable improvements in our patients' health and wellness metrics.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">89% Report Increased Energy</h3>
                    <p className="text-sm text-muted-foreground">Within 24 hours of treatment</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold">76% Better Sleep Quality</h3>
                    <p className="text-sm text-muted-foreground">Improved sleep patterns within one week</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold">92% Faster Recovery</h3>
                    <p className="text-sm text-muted-foreground">Athletes and active individuals</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-3xl p-8">
              <h3 className="font-semibold text-xl mb-6 text-center">Treatment Success Rates</h3>

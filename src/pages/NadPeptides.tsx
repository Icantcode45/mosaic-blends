...
const NadPeptides = () => {
  ...
  const peptideDatabase = {
    ...
    'nad-therapy-100mg': {
      name: 'NAD+ Therapy 100mg',
      category: 'Cellular Wellness',
      duration: 'IV infusion (1-2 hours)',
      administration: 'Intravenous therapy',
      price: '$75',
      benefits: [
        ...
        'Age-related cellular wellness*',
        'Cognitive function support*'
      ],
      description: 'NAD+ therapy with 100mg concentration for cellular energy optimization and wellness support.',
      howItWorks: 'Supports cellular NAD+ levels to enhance mitochondrial function and cellular energy production.',
      idealFor: 'Adults seeking cellular energy enhancement and metabolic optimization.',
      frequency: 'Healthcare provider consultation required for treatment protocols',
      sideEffects: 'Generally well-tolerated - possible mild fatigue during infusion, consult healthcare provider.',
      researchStatus: 'Established therapy with extensive clinical use and research support'
    },
    'nad-therapy-250mg': {
      name: 'NAD+ Therapy 250mg',
      category: 'Cellular Wellness', 
      duration: 'IV infusion (2-3 hours)',
      administration: 'Intravenous therapy',
      price: '$150',
      benefits: [
        'Enhanced cellular energy production*',
        'Advanced NAD+ pathway support*',
      ...
      description: 'Higher concentration NAD+ therapy for enhanced cellular energy and wellness optimization.',
      howItWorks: 'Provides substantial NAD+ support for enhanced mitochondrial function and cellular regeneration.',
      idealFor: 'Adults seeking advanced cellular optimization and energy enhancement.',
      frequency: 'Healthcare provider consultation required for treatment protocols',
      sideEffects: 'Generally well-tolerated - possible mild fatigue during infusion, consult healthcare provider.',
      researchStatus: 'Established therapy with extensive clinical use and research support'
    },
    'nad-therapy-500mg': {
      name: 'NAD+ Therapy 500mg',
      category: 'Cellular Wellness',
      duration: 'IV infusion (3-4 hours)', 
      administration: 'Intravenous therapy',
      price: '$275',
      benefits: [
        'Maximum cellular energy support*',
        'Comprehensive NAD+ enhancement*',
        'Advanced metabolic optimization*',
        'Superior cellular repair*',
        'Peak energy restoration*',
        'Optimal mitochondrial support*',
        'Premium anti-aging support*',
        'Maximum cognitive enhancement*'
      ],
      description: 'Premium high-dose NAD+ therapy for maximum cellular energy and wellness optimization.',
      howItWorks: 'Delivers optimal NAD+ levels for comprehensive cellular regeneration and energy enhancement.',
      idealFor: 'Adults seeking premium cellular optimization and maximum energy enhancement.',
      frequency: 'Healthcare provider consultation required for treatment protocols',
      sideEffects: 'Generally well-tolerated - possible mild fatigue during infusion, consult healthcare provider.',
      researchStatus: 'Established therapy with extensive clinical use and research support'
    },
    'diamond-nad-therapy': {
      name: 'Diamond NAD+ Therapy',
      category: 'Cellular Wellness',
      duration: 'IV infusion (3-4 hours)',
      administration: 'Intravenous therapy',
      price: '$425',
      benefits: [
        'Premium NAD+ optimization*',
        'Enhanced cellular regeneration*',
        'Superior metabolic support*',
        'Advanced energy restoration*',
        'Premium cellular repair*',
        'Optimal mitochondrial function*',
        'Elite anti-aging support*',
        'Maximum wellness optimization*'
      ],
      description: 'Premium Diamond-level NAD+ therapy with enhanced formulation for optimal cellular wellness.',
      howItWorks: 'Combines high-dose NAD+ with premium enhancement factors for superior cellular optimization.',
      idealFor: 'Adults seeking the highest level of cellular optimization and premium wellness support.',
      frequency: 'Healthcare provider consultation required for premium treatment protocols',
      sideEffects: 'Generally well-tolerated - possible mild fatigue during infusion, consult healthcare provider.',
      researchStatus: 'Premium formulation with enhanced clinical protocols and research backing'
    },
    'elite-nad-therapy': {
      name: 'Elite NAD+ Therapy',
      category: 'Cellular Wellness',
      duration: 'IV infusion (4+ hours)',
      administration: 'Intravenous therapy',
      price: '$625',
      benefits: [
        'Elite-level NAD+ optimization*',
        'Maximum cellular regeneration*',
        'Ultimate metabolic support*',
        'Peak energy restoration*',
        'Elite cellular repair mechanisms*',
        'Supreme mitochondrial function*',
        'Ultimate anti-aging support*',
        'Maximum longevity optimization*'
      ],
      description: 'Elite-tier NAD+ therapy representing the pinnacle of cellular optimization and wellness support.',
      howItWorks: 'Delivers the highest concentration of NAD+ with premium enhancement compounds for ultimate cellular wellness.',
      idealFor: 'Adults seeking the ultimate in cellular optimization and peak wellness performance.',
      frequency: 'Healthcare provider consultation required for elite treatment protocols',
      sideEffects: 'Generally well-tolerated - possible mild fatigue during infusion, consult healthcare provider.',
      researchStatus: 'Elite formulation representing the pinnacle of NAD+ therapy research and clinical application'
    },
    'semaglutide': {
      ...
      benefits: [
        ...
        'GLP-1 pathway optimization*',
        'Sustained satiety support*',
        'FDA-approved applications*'
      ],
      description: 'Semaglutide is an FDA-approved GLP-1 receptor agonist for comprehensive weight management and metabolic optimization.',
      howItWorks: 'Advanced GLP-1 receptor agonist that provides superior satiety, metabolic regulation, and weight management support.',
      idealFor: 'Adults seeking physician-supervised advanced weight management and metabolic optimization.',
      frequency: 'Weekly administration under healthcare provider supervision',
      sideEffects: 'FDA-approved with established profile - possible nausea, gastrointestinal effects, consult healthcare provider.',
      researchStatus: 'FDA-approved for weight management with extensive clinical data and ongoing research'
    },
    'tirzepatide': {
      ...
      price: 'Consultation required',
      benefits: [
        'Dual-pathway weight management*',
        'Superior blood sugar control*',
        'Enhanced appetite regulation*',
        'Advanced metabolic optimization*',
        'Cardiovascular protection*',
        'GLP-1 and GIP pathway activation*',
        'Maximum satiety support*',
        'FDA-approved applications*'
      ],
      description: 'Tirzepatide is an FDA-approved dual GLP-1/GIP receptor agonist for superior weight management and metabolic control.',
      howItWorks: 'Activates both GLP-1 and GIP pathways for enhanced metabolic regulation and superior weight management results.',
      idealFor: 'Adults seeking the most advanced physician-supervised weight management and metabolic optimization.',
      frequency: 'Weekly administration under healthcare provider supervision',
      sideEffects: 'FDA-approved with established profile - possible nausea, gastrointestinal effects, consult healthcare provider.',
      researchStatus: 'FDA-approved dual-pathway agonist with superior clinical outcomes and ongoing research'
    },
    'cagrilintide': {
      name: 'Cagrilintide Research',
      category: 'Metabolic Research',
      duration: 'Subcutaneous administration',
      administration: 'Subcutaneous injection',
      benefits: [
        'Amylin pathway research*',
        'Advanced weight management studies*',
        'Gastric emptying research*',
        'Satiety enhancement studies*',
        'Metabolic pathway research*',
        'Combination therapy studies*',
        'Novel mechanism research*',
        'Clinical trial applications*'
      ],
      description: 'Cagrilintide is a research compound studied for advanced weight management through amylin pathway modulation.',
      howItWorks: 'Research suggests amylin receptor agonism for enhanced satiety and metabolic regulation.',
      idealFor: 'Adults interested in advanced metabolic research and novel weight management pathways.',
      frequency: 'Healthcare provider consultation required for research protocols',
      sideEffects: 'Research compound - possible gastrointestinal effects, consult healthcare provider.',
      researchStatus: 'Research compound in clinical development for advanced metabolic applications'
    },
    'retatrutide': {
      ...
      benefits: [
        ...
        'Superior metabolic studies*',
        'Enhanced satiety research*',
        'Multi-receptor pathway studies*',
        'Clinical development research*',
        'Novel mechanism studies*'
      ],
      description: 'Retatrutide is a research compound studying triple-pathway activation for advanced metabolic optimization.',
      howItWorks: 'Research investigates GLP-1, GIP, and glucagon receptor activation for comprehensive metabolic enhancement.',
      idealFor: 'Adults interested in advanced metabolic research and multi-pathway optimization studies.',
      frequency: 'Healthcare provider consultation required for research protocols',
      sideEffects: 'Research compound - possible gastrointestinal effects, consult healthcare provider.',
      researchStatus: 'Research compound representing next-generation multi-pathway metabolic optimization'
    },
    'reta-glp1-r': {
      name: 'Reta GLP-1 R (12mg)',
      category: 'Metabolic Research',
      duration: 'Weekly subcutaneous administration',
      administration: 'Subcutaneous injection',
      benefits: [
        'Advanced GLP-1 research*',
        'Weight management studies*',
        'Metabolic pathway research*',
        'Appetite regulation studies*',
        'Blood sugar research*',
        'Cardiovascular health studies*',
        'Satiety enhancement research*',
        'Clinical trial applications*'
      ],
      description: 'Reta GLP-1 R is a research compound studying advanced GLP-1 receptor agonism for metabolic optimization.',
      howItWorks: 'Research investigates GLP-1 pathway modulation for enhanced metabolic regulation and weight management.',
      idealFor: 'Adults interested in advanced metabolic research and GLP-1 pathway studies.',
      frequency: 'Healthcare provider consultation required for research protocols',
      sideEffects: 'Research compound - possible gastrointestinal effects, consult healthcare provider.',
      researchStatus: 'Advanced GLP-1 research compound in development'
    },
    '2x-blend': {
      name: '2X Blend (Tesa + IPA)',
      category: 'Hormone Research',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
        'Growth hormone research combination*',
        'Synergistic hormone studies*',
        'Body composition research*',
        'Recovery optimization studies*',
        'Sleep quality research*',
        'Anti-aging studies*',
      ...
      description: '2X Blend combines Tesamorelin and Ipamorelin for synergistic hormone research applications.',
      howItWorks: 'Research investigates combined GHRH analog and secretagogue effects for enhanced hormone pathway activation.',
      idealFor: 'Adults interested in combination hormone research and synergistic therapeutic approaches.',
      frequency: 'Healthcare provider consultation required for combination protocols',
      sideEffects: 'Research compound combination - consult healthcare provider for complete safety profile.',
      researchStatus: 'Research combination studying synergistic hormone pathway interactions'
    },
    'glow-blend': {
      name: 'GLOW Blend',
      category: 'Cosmetic Research',
      ...
      benefits: [
        'Skin wellness research*',
        'Beauty enhancement studies*',
        'Collagen production research*',
        'Anti-aging studies*',
        'Cellular regeneration research*',
        'Aesthetic wellness studies*',
        'Radiance enhancement research*',
        'Skin health optimization*'
      ],
      description: 'GLOW Blend is a cosmetic research formulation studying skin wellness and beauty enhancement.',
      howItWorks: 'Research investigates targeted peptide combinations for skin health and aesthetic wellness support.',
      idealFor: 'Adults interested in cosmetic research and skin wellness optimization studies.',
      frequency: 'Healthcare provider consultation required for cosmetic research protocols',
      sideEffects: 'Research compound - possible skin reactions, consult healthcare provider.',
      researchStatus: 'Cosmetic research blend studying aesthetic wellness applications'
    },
    'bpc-157-20mg': {
      name: 'BPC-157 (20mg)',
      category: 'Research & Recovery',
      ...
      description: 'BPC-157 at 20mg concentration for enhanced recovery and tissue wellness research applications.',
      howItWorks: 'Research suggests potential interactions with growth factors and healing pathways at higher concentrations.',
      idealFor: 'Adults interested in advanced recovery research and tissue wellness studies.',
      frequency: 'Healthcare provider consultation required for high-dose research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Enhanced concentration research for advanced recovery applications'
    },
    'tb-500-5mg': {
      name: 'TB-500 (5mg)',
      category: 'Research & Recovery',
      ...
      administration: 'Subcutaneous injection',
      benefits: [
        'Cellular mobility research*',
        'Recovery optimization studies*',
        'Flexibility wellness research*',
      ...
      description: 'TB-500 at 5mg concentration for cellular mobility and recovery research applications.',
      howItWorks: 'Research suggests potential support for cellular migration and tissue repair at optimized dosing.',
      idealFor: 'Adults interested in recovery research and cellular mobility studies.',
      frequency: 'Healthcare provider consultation required for research protocols',
      sideEffects: 'Research compound - studies show good tolerance, consult healthcare provider.',
      researchStatus: 'Optimized dosing research for cellular mobility applications'
    },
    '4x-blend': {
      name: '4X Blend',
      category: 'Hormone Research',
      ...
      administration: 'Subcutaneous injection',
      benefits: [
        'Multi-pathway hormone research*',
        'Comprehensive growth factor studies*',
        'Advanced recovery research*',
        'Body composition optimization*',
        'Sleep enhancement studies*',
        'Anti-aging research*',
        'Performance optimization studies*',
        'Synergistic effects research*'
      ],
      description: '4X Blend combines four research peptides for comprehensive hormone pathway investigation.',
      howItWorks: 'Research investigates multi-peptide interactions for enhanced hormone optimization and wellness support.',
      idealFor: 'Adults interested in advanced combination research and comprehensive hormone studies.',
      frequency: 'Healthcare provider consultation required for complex combination protocols',
      sideEffects: 'Research compound combination - comprehensive evaluation required, consult healthcare provider.',
      researchStatus: 'Advanced combination research studying multi-pathway hormone interactions'
    },
    'nad-1000mg': {
      name: 'NAD+ (1000mg/10mL)',
      category: 'Cellular Wellness',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
        'Concentrated cellular energy support*',
        'Advanced NAD+ pathway enhancement*',
      ...
      description: 'High-concentration NAD+ at 1000mg/10mL for advanced cellular energy and wellness optimization.',
      howItWorks: 'Concentrated NAD+ formulation for enhanced cellular energy production and mitochondrial support.',
      idealFor: 'Adults seeking advanced cellular optimization and concentrated NAD+ therapy.',
      frequency: 'Healthcare provider consultation required for high-concentration protocols',
      sideEffects: 'Generally well-tolerated - possible mild reactions, consult healthcare provider.',
      researchStatus: 'High-concentration NAD+ formulation with enhanced bioavailability research'
    },
    'cjc-1295-10mg': {
      name: 'CJC-1295 (10mg)',
      category: 'Hormone Research',
      ...
      benefits: [
        'Growth hormone pathway research*',
        'Extended hormone release studies*',
        'Muscle wellness research*',
        'Recovery optimization studies*',
      ...
      description: 'CJC-1295 at 10mg concentration for extended growth hormone pathway research.',
      howItWorks: 'Research suggests extended interaction with GHRH receptors for prolonged hormone release patterns.',
      idealFor: 'Adults interested in extended hormone research and growth factor studies.',
      frequency: 'Healthcare provider consultation required for extended-release protocols',
      sideEffects: 'Research compound - possible water retention, injection site reactions, consult healthcare provider.',
      researchStatus: 'Extended-release hormone research with optimized concentration studies'
    },
    'ipamorelin-10mg': {
      ...
      description: 'Ipamorelin at 10mg concentration for selective hormone pathway research.',
      howItWorks: 'Research suggests selective growth hormone secretagogue activity without affecting other hormones.',
      idealFor: 'Adults interested in selective hormone research with minimal variables.',
      frequency: 'Healthcare provider consultation required for selective hormone protocols',
      sideEffects: 'Research indicates excellent tolerability - consult healthcare provider.',
      researchStatus: 'Selective hormone research compound with optimized dosing studies'
    },
    'tesamorelin-10mg': {
      ...
      benefits: [
        ...
        'Hormone pathway optimization*',
        'Cardiovascular wellness studies*',
        'Liver function research*',
        'FDA-approved mechanisms*',
        'Lipodystrophy research*'
      ],
      description: 'Tesamorelin at 10mg concentration for metabolic and body composition research.',
      howItWorks: 'Research investigates GHRH receptor activation for metabolic benefits at optimized dosing.',
      idealFor: 'Adults interested in metabolic research and body composition optimization.',
      frequency: 'Healthcare provider consultation required for metabolic protocols',
      sideEffects: 'Research compound with established mechanisms - consult healthcare provider.',
      researchStatus: 'Metabolic research with FDA-approved pathway mechanisms'
    },
    'ghrp-2': {
      name: 'GHRP-2 (10mg)',
      category: 'Hormone Research',
      ...
      description: 'GHRP-2 is a growth hormone releasing peptide studied for hormone pathway research.',
      howItWorks: 'Research suggests potent growth hormone secretagogue activity with appetite enhancement effects.',
      idealFor: 'Adults interested in growth hormone research and appetite regulation studies.',
      frequency: 'Healthcare provider consultation required for hormone research protocols',
      sideEffects: 'Research compound - possible increased appetite, water retention, consult healthcare provider.',
      researchStatus: 'Growth hormone research peptide with appetite modulation studies'
    },
    'ghrp-6': {
      name: 'GHRP-6 (10mg)',
      category: 'Hormone Research',
      ...
      description: 'GHRP-6 is a growth hormone releasing peptide with appetite enhancement research applications.',
      howItWorks: 'Research suggests growth hormone secretagogue activity with significant appetite stimulation effects.',
      idealFor: 'Adults interested in growth hormone research and appetite enhancement studies.',
      frequency: 'Healthcare provider consultation required for hormone research protocols',
      sideEffects: 'Research compound - possible increased appetite, water retention, consult healthcare provider.',
      researchStatus: 'Growth hormone research with appetite enhancement applications'
    },
    'sermorelin-15mg': {
      ...
      benefits: [
        'Natural hormone pathway research*',
        'Enhanced sleep quality studies*',
        'Recovery optimization research*',
        'Body composition studies*',
        'Energy wellness research*',
        'Longevity studies*',
        'Circadian rhythm research*',
        'Natural GHRH analog studies*'
      ],
      description: 'Sermorelin at 15mg concentration for enhanced natural hormone pathway research.',
      howItWorks: 'Enhanced concentration GHRH analog research for optimized natural hormone release patterns.',
      idealFor: 'Adults seeking enhanced natural hormone pathway research and physiological wellness.',
      frequency: 'Healthcare provider consultation required for enhanced natural protocols',
      sideEffects: 'Generally well-tolerated - possible injection site reactions, consult healthcare provider.',
      researchStatus: 'Enhanced concentration natural hormone research with established safety'
    },
    'mots-c': {
      name: 'MOTS-c (10mg)',
      category: 'Cellular Wellness',
      ...
      description: 'MOTS-c is a mitochondrial-derived peptide studied for cellular energy and metabolic optimization.',
      howItWorks: 'Research suggests mitochondrial regulation and metabolic pathway enhancement through cellular signaling.',
      idealFor: 'Adults interested in mitochondrial research and cellular energy optimization.',
      frequency: 'Healthcare provider consultation required for mitochondrial research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Mitochondrial research peptide with cellular energy optimization studies'
    },
    'aod-9604-5mg': {
      name: 'AOD-9604 (5mg)',
      category: 'Metabolic Research',
      ...
      description: 'AOD-9604 at 5mg concentration for metabolic and body composition research.',
      howItWorks: 'Research suggests fat metabolism pathway interactions at optimized concentration without growth effects.',
      idealFor: 'Adults interested in metabolic research and body composition studies.',
      frequency: 'Healthcare provider consultation required for metabolic research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Metabolic research with optimized concentration for body composition studies'
    },
    'epithalon-10mg': {
      name: 'Epithalon (10mg)',
      category: 'Longevity Research',
      ...
      benefits: [
        ...
        'Melatonin regulation studies*',
        'Pineal gland research*'
      ],
      description: 'Epithalon at 10mg concentration for enhanced longevity and anti-aging research.',
      howItWorks: 'Research suggests telomerase activation and pineal gland function at optimized concentration.',
      idealFor: 'Adults interested in longevity research and anti-aging studies.',
      frequency: 'Healthcare provider consultation required for longevity research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Longevity research with optimized concentration for anti-aging applications'
    },
    'ghk-cu-20mg': {
      name: 'GHK-Cu (20mg)',
      category: 'Cosmetic Research',
      ...
      administration: 'Subcutaneous injection',
      benefits: [
        'Enhanced skin wellness research*',
        'Collagen production optimization*',
        'Wound healing enhancement*',
        'Anti-aging studies*',
        'Hair growth research*',
        'Tissue repair studies*',
        'Copper peptide research*',
        'Enhanced cosmetic applications*'
      ],
      description: 'GHK-Cu at 20mg concentration for enhanced skin wellness and cosmetic research.',
      howItWorks: 'Research suggests enhanced copper peptide interactions for collagen synthesis at higher concentration.',
      idealFor: 'Adults interested in enhanced cosmetic research and skin wellness optimization.',
      frequency: 'Healthcare provider consultation required for enhanced cosmetic protocols',
      sideEffects: 'Research compound - possible skin reactions, consult healthcare provider.',
      researchStatus: 'Enhanced concentration cosmetic research for advanced skin wellness applications'
    },
    'igf-1-lr3': {
      name: 'IGF-1 LR3 (1mg)',
      category: 'Research & Recovery',
      ...
      benefits: [
        ...
        'Recovery enhancement research*',
        'Cellular growth studies*',
        'Protein synthesis research*',
        'Tissue repair studies*',
        'Performance optimization research*',
        'Anti-aging studies*'
      ],
      description: 'IGF-1 LR3 is a long-acting insulin-like growth factor studied for cellular growth research.',
      howItWorks: 'Research suggests extended IGF-1 activity for enhanced cellular growth and repair mechanisms.',
      idealFor: 'Adults interested in growth factor research and cellular development studies.',
      frequency: 'Healthcare provider consultation required for growth factor research protocols',
      sideEffects: 'Research compound - possible hypoglycemia, consult healthcare provider.',
      researchStatus: 'Growth factor research compound with extended activity studies'
    },
    'igf-1-des': {
      name: 'IGF-1 DES (1mg)',
      category: 'Research & Recovery',
      ...
      administration: 'Subcutaneous injection',
      benefits: [
        'Localized growth factor research*',
        ...
        'Localized effects studies*'
      ],
      description: 'IGF-1 DES is a truncated insulin-like growth factor studied for localized growth research.',
      howItWorks: 'Research suggests localized IGF-1 activity for targeted cellular growth and repair.',
      idealFor: 'Adults interested in localized growth factor research and targeted tissue studies.',
      frequency: 'Healthcare provider consultation required for localized growth factor protocols',
      sideEffects: 'Research compound - possible hypoglycemia, consult healthcare provider.',
      researchStatus: 'Localized growth factor research with targeted tissue applications'
    },
    'thymosin-alpha-1': {
      ...
      description: 'Thymosin Alpha-1 is an immune-modulating peptide studied for immune system optimization.',
      howItWorks: 'Research suggests T-cell activation and immune system enhancement through thymic peptide pathways.',
      idealFor: 'Adults interested in immune system research and T-cell function studies.',
      frequency: 'Healthcare provider consultation required for immune research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Immune research peptide with T-cell optimization studies'
    },
    'melanotan-ii-10mg': {
      ...
      description: 'Melanotan II at 10mg concentration for pigmentation and metabolic research.',
      howItWorks: 'Research suggests melanocortin receptor interactions affecting pigmentation and metabolic pathways.',
      idealFor: 'Adults interested in pigmentation research and UV protection studies.',
      frequency: 'Healthcare provider consultation required for pigmentation research protocols',
      sideEffects: 'Research compound - possible nausea, skin darkening, consult healthcare provider.',
      researchStatus: 'Pigmentation research compound with metabolic pathway studies'
    },
    'kisspeptin-10': {
      ...
      description: 'Kisspeptin-10 is a reproductive hormone research peptide studying GnRH pathway regulation.',
      howItWorks: 'Research suggests GnRH release stimulation and reproductive hormone pathway activation.',
      idealFor: 'Adults interested in reproductive hormone research and endocrine studies.',
      frequency: 'Healthcare provider consultation required for hormone research protocols',
      sideEffects: 'Research compound - possible hormone fluctuations, consult healthcare provider.',
      researchStatus: 'Reproductive hormone research with GnRH pathway studies'
    },
    'pt-141-10mg': {
      name: 'PT-141 (10mg)',
      category: 'Wellness Research',
      ...
      description: 'PT-141 at 10mg concentration for sexual wellness research applications.',
      howItWorks: 'Research investigates melanocortin receptor activation in central nervous system arousal pathways.',
      idealFor: 'Adults interested in sexual wellness research and CNS pathway studies.',
      frequency: 'Healthcare provider consultation required for wellness research protocols',
      sideEffects: 'Research compound with FDA-approved mechanisms - possible nausea, consult healthcare provider.',
      researchStatus: 'Sexual wellness research with FDA-approved pathway mechanisms'
    },
    'selank': {
      name: 'Selank (5mg)',
      category: 'Neuroscience Research',
      ...
      description: 'Selank is a synthetic peptide studied for cognitive enhancement and anxiety research.',
      howItWorks: 'Research suggests GABA and serotonin pathway modulation for cognitive and mood benefits.',
      idealFor: 'Adults interested in cognitive research and stress response studies.',
      frequency: 'Healthcare provider consultation required for cognitive research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Cognitive research peptide with neuroprotection studies'
    },
    'semax': {
      name: 'Semax (5mg)',
      category: 'Neuroscience Research',
      ...
      description: 'Semax is a synthetic peptide studied for cognitive enhancement and neuroprotection.',
      howItWorks: 'Research suggests BDNF and neurotrophin pathway activation for cognitive enhancement.',
      idealFor: 'Adults interested in cognitive research and neuroprotection studies.',
      frequency: 'Healthcare provider consultation required for cognitive research protocols',
      sideEffects: 'Research compound - generally well-tolerated, consult healthcare provider.',
      researchStatus: 'Cognitive research peptide with neuroprotection applications'
    },
    'll-37': {
      name: 'LL-37 (10mg)',
      category: 'Immune Research',
      ...
      benefits: [
        ...
        'Immune defense studies*',
        'Wound healing research*',
        'Skin barrier studies*',
        'Infection resistance research*',
        'Inflammatory response studies*',
        'Tissue repair research*',
        'Innate immunity studies*'
      ],
      description: 'LL-37 is an antimicrobial peptide studied for immune defense and wound healing research.',
      howItWorks: 'Research suggests antimicrobial activity and immune system enhancement through cathelicidin pathways.',
      idealFor: 'Adults interested in immune defense research and antimicrobial studies.',
      frequency: 'Healthcare provider consultation required for immune research protocols',
      sideEffects: 'Research compound - possible immune reactions, consult healthcare provider.',
      researchStatus: 'Antimicrobial research with immune defense applications'
    },
    'thymosin-beta-4-fragment': {
      name: 'Thymosin Beta-4 Fragment (10mg)',
      category: 'Research & Recovery',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
      ...
      description: 'Thymosin Beta-4 Fragment is a targeted peptide studied for specific tissue repair research.',
      howItWorks: 'Research suggests targeted actin regulation and cellular migration through specific fragment activity.',
      idealFor: 'Adults interested in targeted recovery research and tissue repair studies.',
      frequency: 'Healthcare provider consultation required for fragment research protocols',
      sideEffects: 'Research compound - studies show good tolerance, consult healthcare provider.',
      researchStatus: 'Fragment-specific research for targeted tissue repair applications'
    },
    'foxo4-dri': {
      name: 'FOXO4-DRI (10mg)',
      category: 'Longevity Research',
      ...
      benefits: [
        ...
        'Age-related studies*',
        'Cellular clearance research*',
        'Senolytic studies*'
      ],
      description: 'FOXO4-DRI is a research peptide studied for senescent cell targeting and anti-aging applications.',
      howItWorks: 'Research suggests senescent cell targeting and cellular rejuvenation through FOXO4 pathway disruption.',
      idealFor: 'Adults interested in anti-aging research and cellular rejuvenation studies.',
      frequency: 'Healthcare provider consultation required for senolytic research protocols',
      sideEffects: 'Research compound - limited human data, consult healthcare provider.',
      researchStatus: 'Advanced anti-aging research with senolytic applications'
    },
    'ghk-cu-argireline': {
      name: 'GHK-Cu + Argireline (10mg)',
      category: 'Cosmetic Research',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
        'Advanced skin wellness research*',
        'Wrinkle reduction studies*',
        'Collagen enhancement research*',
        'Anti-aging cosmetic studies*',
        'Muscle relaxation research*',
        'Skin texture studies*',
        'Combination therapy research*',
        'Aesthetic enhancement studies*'
      ],
      description: 'GHK-Cu + Argireline combination for advanced cosmetic research and skin wellness.',
      howItWorks: 'Research investigates copper peptide and muscle relaxation combination for enhanced cosmetic benefits.',
      idealFor: 'Adults interested in advanced cosmetic research and anti-aging skin studies.',
      frequency: 'Healthcare provider consultation required for combination cosmetic protocols',
      sideEffects: 'Research compound combination - possible skin reactions, consult healthcare provider.',
      researchStatus: 'Advanced cosmetic research combining copper peptides with muscle relaxation'
    },
    'curcumin': {
      name: 'Curcumin (100mg/mL, 10mL)',
      category: 'Wellness Research',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
      ...
      description: 'Injectable Curcumin formulation for anti-inflammatory and antioxidant research applications.',
      howItWorks: 'Research suggests anti-inflammatory and antioxidant pathways through curcumin bioactivity.',
      idealFor: 'Adults interested in anti-inflammatory research and antioxidant studies.',
      frequency: 'Healthcare provider consultation required for anti-inflammatory protocols',
      sideEffects: 'Research compound - possible injection site reactions, consult healthcare provider.',
      researchStatus: 'Anti-inflammatory research with injectable curcumin formulations'
    },
    'resveratrol': {
      name: 'Resveratrol (100mg/mL, 10mL)',
      category: 'Longevity Research',
      duration: 'Brief administration (5-10 minutes)',
      administration: 'Subcutaneous injection',
      benefits: [
      ...
      description: 'Injectable Resveratrol formulation for longevity and antioxidant research applications.',
      howItWorks: 'Research suggests sirtuin activation and antioxidant pathways through resveratrol bioactivity.',
      idealFor: 'Adults interested in longevity research and antioxidant studies.',
      frequency: 'Healthcare provider consultation required for longevity protocols',
      sideEffects: 'Research compound - possible injection site reactions, consult healthcare provider.',
      researchStatus: 'Longevity research with injectable resveratrol formulations'
    }
  };
